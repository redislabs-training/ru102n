...
// the instructors full name at that key, not just their first
...
// Now that we've set a number in a string, we can run numeric
...
// You can also pass in a floating point, which will 
