...
// You'll notice that we never initialized the allUserSet, well let's do that now. We'll consider the allUsersSet to
...
// Next, let's look at enumerating all the members of a set. There is realistically two ways we can do this
